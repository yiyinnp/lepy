...
<div class="flex justify-center items-center pt-28">
    <div class="flex justify-center items-center w-8/12">
        <div class="w-full p-6 shadow-md bg-[#D9D9D9] rounded-md">
            <h1 class="text-3xl block text-center font-semibold">Buat Forum Diskusi Baru</h1>
            <form action="{{ route('forumsdashboard.store') }}" method="POST">
                @csrf
                <div class="mt-3">
                ...
                <div class="mt-2">
                    <button type="submit" class="border-2 border-gray-400 bg-gray-400 text-white py-1 w-full rounded-md hover:bg-gray-500 hover:border-gray-500 font-semibold"><i class="bi bi-x-lg"></i> Kembali</button>
                </div>
            </form>
        </div>
    </div>
