    ...
    <div class="flex-none w-8/12 h-96 pr-10">
        <form id="compilerForm" class="mx-auto bg-[#395886] p-5 rounded-lg shadow-md">
            ...
            <div class="flex justify-between">
                ...
                <div>
                    <a href="{{ route('compile.sequential.1') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-4 py-2 rounded hover:bg-blue-400 focus:outline-none focus:ring focus:border-blue-500"><i class="bi bi-caret-left-fill"></i></button></a>
