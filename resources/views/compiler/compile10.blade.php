...
@section('container')
@php
    $questions = \App\Models\Question::where('id', 10)->value('content');
    $correctAnswer = \App\Models\Answer::where('id', 10)->value('content');
    ...
    <div class="flex-none lg:w-8/12 w-full h-96 lg:pr-5 pr-0 lg:mb-0 mb-5">
        <form id="compilerForm" class="mx-auto bg-[#395886] px-4 pb-4 lg:mb-0 mb-5 pt-2 rounded-lg shadow-md">
            ...
            <div class="flex justify-between items-center hidden sm:flex">
                ...
                <div>
                    <a href="{{ route('compile.tipedata.4') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-3 py-2 mt-1 rounded hover:bg-blue-400"><i class="bi bi-caret-left-fill"></i></button></a>
