...
@section('container')
@php
    $questions = \App\Models\Question::where('id', 21)->value('content');
    $correctAnswer = \App\Models\Answer::where('id', 21)->value('content');
        ...
        <form id="compilerForm" class="mx-auto bg-[#395886] px-4 pb-4 lg:mb-0 mb-5 pt-2 rounded-lg shadow-md">
            ...
            <div class="flex justify-between items-center hidden sm:flex">
                ...
                <div>
                    ...
                    <a href="{{ route('compile.looping.2') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-3 py-2 mt-1 rounded hover:bg-blue-400"><i class="bi bi-caret-right-fill"></i></button></a>
                </div>
            </div>
