        ...
        <form id="compilerForm" class="mx-auto bg-[#395886] px-4 pb-4 lg:mb-0 mb-5 pt-2 rounded-lg shadow-md">
            <div>
                <div class="flex justify-between items-center">
                    <label for="code" class="block text-white text- font-bold mb-2">Ketikan Kode Program Anda:</label>
            ...
            <div class="flex justify-between items-center hidden sm:flex">
                ...
                <div>
                    <a href="{{ route('compile.variable.2') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-3 py-2 mt-1 rounded hover:bg-blue-400"><i class="bi bi-caret-left-fill"></i></button></a>
                    <label for="" class="text-center ml-2 mt-1 font-medium text-white">3/5</label>
                    <a href="{{ route('compile.variable.4') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-3 py-2 mt-1 rounded hover:bg-blue-400"><i class="bi bi-caret-right-fill"></i></button></a>
                </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('compilerForm').addEventListener('submit', function(event) {
            ...
            .catch(error => {
                ...
                document.getElementById('warning').innerText = '';
                document.getElementById('error').innerText = "Python tidak dapat mengeksekusi perintah yang Anda masukkan";
            });
        });
