        ...
        <form id="compilerForm" class="mx-auto bg-[#395886] px-4 pb-4 lg:mb-0 mb-5 pt-2 rounded-lg shadow-md" action="/compile" method="POST">
            ...
            <div class="flex justify-between items-center hidden sm:flex">
                ...
                <div>
                    ...
                    <a href="{{ route('compile.variable.2') }}"><button type="button" class="ml-2 bg-blue-300 text-gray-700 px-3 py-2 mt-1 rounded hover:bg-blue-400"><i class="bi bi-caret-right-fill"></i></button></a>
                </div>
            </div>
            ...
            .then(data => {
                ...
                if (userCode === correctAnswer) {
                    ...
                    fetch('/update-leaderboard', {
                        ...
                        body: JSON.stringify({ userId: userId, score: 20 }) // Data yang dikirimkan sebagai JSON
                    })
                    .then(response => {
                        if (!response.ok) {
                            throw new Error('Network response was not ok');
