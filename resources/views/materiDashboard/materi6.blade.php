        ...
        <div class="w-9/12 ">
            <div class="pb-2">
                <h4 class="lg:text-lg text-base text-justify pb-4">
                    ...
                    Setiap percabangan memiliki suatu <b>kondisi</b> atau syarat (<i>conditional statement</i>) dan <b>aksi</b>. Setiap kondisi memiliki dua kemungkinan; <b>benar</b> atau <b>salah</b>.
                    ...
                    <ul class="list-decimal lg:pl-10 pl-5">
                        ...
                        <div class="py-2">
                            <div class="lg:pl-10 pl-3">
                                <div class="w-52 p-3 bg-[#D9D9D9] rounded-md" style="font-family: 'Source Code Pro';">
                                    <div class="">
                                        <h3 class="lg:text-xl text-lg font-semibold text-purple-800">if <span class="text-yellow-500">(<span class="text-green-500">ekspresi</span>)</span>:</h3>
                        ...
                        <div class="py-2">
                            <div class="lg:px-10 px-2 overflow-x-auto">
                                <div class="lg:w-full w-[28rem] p-3 bg-slate-700 rounded-lg" style="font-family: 'Source Code Pro';">
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Mendefinisikan variabel nilai</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white">nilai = <span class="text-rose-500">70</span></h3>
                                    <br>
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Percabangan if</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">if</span> nilai >= <span class="text-rose-500">70</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Selamat, Anda lulus ujian!"</span>)</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        tetapi juga digunakan untuk menentukan tindakan apa yang akan diambil apa yang akan diambil apabila tidak sesuai dengan kondisi yang syaratkan. Untuk mengantisipasi keperluan tersebut, sintaks percabangan if dapat dikembangkan menjadi:
                        <div class="py-2">
                            <div class="lg:pl-10 pl-3">
                                <div class="w-52 p-3 bg-[#D9D9D9] rounded-md" style="font-family: 'Source Code Pro';">
                                    <div class="">
                                        <h3 class="lg:text-xl text-lg font-semibold text-purple-500">if <span class="text-yellow-500">(<span class="text-green-500">ekspresi</span>)</span>:</h3>
                                        <h3 class="lg:text-xl text-lg font-semibold ml-5 text-gray-700">pernyataan</h3>
                        ...
                        <div class="py-2">
                            <div class="lg:px-10 px-2 overflow-x-auto">
                                <div class="lg:w-full w-[40rem] p-3 bg-slate-700 rounded-lg" style="font-family: 'Source Code Pro';">
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Mendefinisikan variabel nilai</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white">nilai = <span class="text-rose-500">65</span></h3>
                                    <br>
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Percabangan if..else</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">if</span> nilai >= <span class="text-rose-500">70</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Selamat, Anda lulus ujian!"</span>)</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">else</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Maaf, Anda belum lulus. Silakan coba lagi."</span>)</h3>
                                </div>
                            </div>
                        </div>
                        <div class="flex justify-center py-5">
                        ...
                        <div class="py-2">
                            <div class="lg:pl-10 pl-3">
                                <div class="w-52 p-3 bg-[#D9D9D9] rounded-md" style="font-family: 'Source Code Pro';">
                                    <div class="pl-4">
                                        <h3 class="lg:text-xl text-lg font-semibold text-purple-500">if <span class="text-yellow-500">(<span class="text-green-500">ekspresi1</span>)</span>:</h3>
                                        <h3 class="lg:text-xl text-lg font-semibold ml-5 text-gray-700">pernyataan1</h3>
                                        <h3 class="lg:text-xl text-lg font-semibold text-purple-500">elif <span class="text-yellow-500">(<span class="text-green-500">ekspresi2</span>)</span>:</h3>
                                        <h3 class="lg:text-xl text-lg font-semibold ml-5 text-gray-700">pernyataan2</h3>
                                        <h3 class="lg:text-xl text-lg font-semibold text-purple-500">elif <span class="text-yellow-500">(<span class="text-green-500">ekspresi3</span>)</span>:</h3>
                        ...
                        <div class="py-2">
                            <div class="lg:px-10 px-2 overflow-x-auto">
                                <div class="lg:w-full w-96 p-3 bg-slate-700 rounded-lg" style="font-family: 'Source Code Pro';">
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Mendefinisikan variabel angka</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white">angka = <span class="text-rose-500">1</span></h3>
                                    <br>
                                    <h3 class="lg:text-lg text-base font-md text-gray-400"># Percabangan elif</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">if</span> angka > <span class="text-rose-500">0</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Bilangan Positif"</span>)</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">elif</span> angka < <span class="text-rose-500">0</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Bilangan Negatif"</span>)</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"><span class="text-blue-500">else</span>:</h3>
                                    <h3 class="lg:text-lg text-base font-md text-white"> <span class="text-yellow-500 pl-4">print</span>(<span class="text-green-500">"Bilangan 0"</span>)</h3>
                                </div>
                            </div>
                        </div>
