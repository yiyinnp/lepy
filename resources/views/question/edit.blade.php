        ...
        <div class="flex justify-center items-center w-8/12">
            <div class="w-full p-6 shadow-lg bg-white rounded-md">
                ...
                <form action="{{ route('questions.update', $question->id) }}" method="POST">
                    ...
                    <div class="mt-3">
                        <label for="content" class="block text-base mb-1">Pertanyaan</label>
                ...
                <div class="mt-2">
                    <a href="{{ route('questions.index') }}"><button type="submit" class="border-2 border-gray-400 bg-gray-400 text-white py-1 w-full rounded-md hover:scale-105 font-semibold"><i class="bi bi-x-lg"></i> Kembali</button></a>
                </div>
            </div>
        </div>
    </div>
