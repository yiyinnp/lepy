            ...
            <h4 class="text-lg text-justify pb-4">
                ...
                <ul class="list-decimal pl-10">
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('compile.ifstatement.1') }}"><button class="border-4 border-[#395886] bg-[#638ECB] text-white py-2 w-72 rounded-md hover:bg-[#395886] font-medium">Ayo Latihan Live Coding</button></a>
                    </div>
                    <br>
                    ...
                    <div class="flex justify-center">
                        <a href="{{ route('compile.ifelsestatement.1') }}"><button class="border-4 border-[#395886] bg-[#638ECB] text-white py-2 w-72 rounded-md hover:bg-[#395886] font-medium">Ayo Latihan Live Coding</button></a>
                    </div>
                    <br>
                    ...
                    <div class="pb-20 flex justify-center">
                        <a href="{{ route('compile.elifstatement.1') }}"><button class="border-4 border-[#395886] bg-[#638ECB] text-white py-2 w-72 rounded-md hover:bg-[#395886] font-medium">Ayo Latihan Live Coding</button></a>
                    </div>
                </ul>
            </h4>
        </div>
...
<div class="bg-[#395886] fixed py-3 px-10 bottom-0 w-full">
    <div class="flex justify-between items-center">
        <a href="{{ route('material.sequential') }}" class="text-white text-sm underline underline-offset-2"><i class="bi bi-chevron-double-left"></i> Struktur Berurutan Pemrograman Python</a>
        <a href="{{ route('material.looping') }}" class="text-white text-sm underline underline-offset-2">Struktur Perulangan Pemrograman Python <i class="bi bi-chevron-double-right"></i></a>
    </div>
</div>
@endsection