...
<div class="flex justify-center items-center pt-10">
    <div class="w-9/12 ">
        <div class="pb-2">
            ...
            <h4 class="text-lg text-justify pb-4">
                ...
                <div class="py-2">
                    <div class="px-10">
                        <div class="w-full p-3 bg-slate-700 rounded-lg">
                            <h3 class="text-lg font-md font-[Montserrat] text-gray-400"># Cara pertama konversi variabel</h3>
                            <h3 class="text-lg font-md font-[Montserrat] text-white">angka = <span class="text-rose-500">"10"</span></h3>
                            <h3 class="text-lg font-md font-[Montserrat] text-white">angka = <span class="text-yellow-500">int</span>(angka)</h3>
                            <br>
                            <h3 class="text-lg font-md font-[Montserrat] text-gray-400"># Cara kedua konversi variabel</h3>
                            <h3 class="text-lg font-md font-[Montserrat] text-white">angka = <span class="text-yellow-500">input</span>(<span class="text-green-500">"Masukkan angka: "</span>)</h3>
                            <h3 class="text-lg font-md font-[Montserrat] text-white">angka = <span class="text-yellow-500">int</span>(angka)</h3>
                            <br>
                            <h3 class="text-lg font-md font-[Montserrat] text-gray-400"># Cara ketiga konversi variabel</h3>
                            <h3 class="text-lg font-md font-[Montserrat] text-white">angka = <span class="text-yellow-500">int</span>(<span class="text-yellow-500">input</span>(<span class="text-green-500">"Masukkan angka: "</span>))</h3>
                            </div>
                    </div>
                </div>
            </h4>
        ...
        <div class="pb-20 flex justify-center">
            <a href="{{ route('compile.variable.1') }}"><button class="border-4 border-[#395886] bg-[#638ECB] text-white py-2 w-72 rounded-md hover:bg-[#395886] font-medium">Ayo Latihan Live Coding</button></a>
        </div>
    </div>
</div>
@endsection
...
<div class="bg-[#395886] fixed py-3 px-10 bottom-0 w-full">
    <div class="flex justify-between items-center">
        <a href="{{ route('material.definition') }}" class="text-white text-sm underline underline-offset-2"><i class="bi bi-chevron-double-left"></i> Pengenalan Pemrograman Python</a>
        <a href="{{ route('material.datatype') }}" class="text-white text-sm underline underline-offset-2">Tipe Data Pemrograman Python <i class="bi bi-chevron-double-right"></i></a>
    </div>
</div>
@endsection