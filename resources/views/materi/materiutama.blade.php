...
<div class="flex justify-center items-center pt-28">
    <h1 class="text-4xl font-black text-zinc-900">{{ $title }}</h1>
</div>
<div class="flex justify-center items-center pt-10">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.definition') }}">
...
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.variable') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.datatype') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.operatorexpresion') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.sequential') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.branching') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.looping') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
<div class="flex justify-center items-center pt-7 pb-10">
    <div class="w-8/12 p-6 shadow-md bg-[#d9d9d9] rounded-xl">
        ...
        <div class="pt-4 float-right">
            <a href="{{ route('material.array') }}"><button class="border-2 border-[#638ECB] bg-[#638ECB] text-white py-1 w-48 rounded-full hover:scale-105 duration-300 font-semibold">Baca Selanjutnya...</button></a>
        </div>
    </div>
</div>
@endsection