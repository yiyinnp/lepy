...
@section('container')
<div class="flex justify-center items-center pt-24 pl-16 center">
    <h1 class="text-5xl font-extrabold w-9/12 text-center">{{ $title }}</h1>
</div>
<div class="flex justify-center items-center pt-10 pl-16">
    <div class="w-9/12 ">
        <div class="pb-2">
...
<div class="bg-[#395886] fixed py-3 px-10 bottom-0 w-full">
    <div class="flex justify-end items-center">
        <a href="{{ route('material.variable') }}" class="text-white text-sm underline underline-offset-2">Pendeklarasian Variable Pemrograman Python <i class="bi bi-chevron-double-right"></i></a>
    </div>
</div>
@endsection